...
const INSTRUCTION = [
  ...
  '',
  'For pay-period, upcoming-commitment / bills, and credit-picture questions, cite only primitive path/equals claims already in this packet. Preferred paths:',
  ...
  'Do not cite a whole object or array as equals. Cite at most 8 claims. If the question asks what to do, how to allocate extra cash, or any other planner act, return status "unavailable" with an empty claims array.',
  '',
  'You MUST NOT:',
