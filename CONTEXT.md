...
read order; this file is one entry in it. Task procedure loads on demand from
[`docs/skills/README.md`](docs/skills/README.md). Technical lessons in
[`docs/lessons/TECHNICAL.md`](docs/lessons/TECHNICAL.md) are
non-authoritative.
