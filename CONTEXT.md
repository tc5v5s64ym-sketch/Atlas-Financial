...
|---|---|---|---|
| Budget (homepage `/`) | `index.html` | `plan.js` + `forecast.js` | The payday waterfall through Predicted Ending Balance; forecast diagnostics below |
