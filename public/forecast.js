...
(function (root) {
  ...
  // Owner decision 2026-09-02: Travel Visa + MBNA / Triangle Amazon
  // *purchases* are Amanda; Prime stays a bill on either card.
  ...
  function classifyCurrentPeriodTransaction(tx, plan, opts) {
    ...
    // Overlay may stamp subscriptionBill / kind before stripping payee.
    ...
    // Owner decision 2026-09-02: Amazon shopping on Travel Visa or
    // Amazon MBNA / Triangle ("mana") is Amanda guilt-free. Payments to
    // those cards already returned as card-payment / transfer above.
  ...
  // Owner decision 2026-09-02: Amazon shopping on Travel Visa or Amazon
  // MBNA / Triangle is Amanda. Prime is a subscription bill, not owner
  // evidence. No evidence, or both names, fails closed to unassigned.
