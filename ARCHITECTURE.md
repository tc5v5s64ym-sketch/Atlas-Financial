...
5. Today's live plan may overlay current posted balances and pending
   ...
   the dated opening or snapshots. The clone's Forecast start is the
   observation's household financial date; same-day scheduled cash
   events need posting/representation evidence or the overlay fails
   closed. Forecast still calculates. Explicit
