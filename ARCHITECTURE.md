...
5. Today's live plan may overlay current posted balances and pending
   ...
   bills / leftover as today's operating waterfall) are withheld. The Plan
...
not put that bill's cash back into Payday balance. Household
budget owner-target lines, extra on the highest-rate revolving card,
other revolving cards, and big purchases follow that corrected
post-bills leftover. Running leftover after each consuming block is
published by
