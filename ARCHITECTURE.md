...
|---|---|
| The website | visual presentation and inspection of the plan. The household Talk page consumes the same sanitized assistant packet via session-only `GET /talk/context` for future conversation use; it does not invent answers. |
