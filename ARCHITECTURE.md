...
5. Today's live plan may overlay current posted balances and pending
   ...
   (later income as arriving, Balance after payday as dated cash plus that income,
   ...
   presented as the financial as-of. Current Balance glance uses the
...
is the payday operating sheet: Current Balance is posted / starting cash
(`paydayAllocation.opening`, not overdraft and not same-day arriving income),
Balance after payday is that opening plus arriving payday-period income,
