...
from posted canonical `chequing-a` / BILLS ACCOUNT cash
(`Forecast` `postedBillsAccountCash`) is Current Balance — the planning
hub only. Chequing B / WEEKLY SPENDING, designated savings, Travel Visa,
...
TENNIS INCOME, not overdraft, not Weekly, and not same-day arriving income, and is printed outside the payday
