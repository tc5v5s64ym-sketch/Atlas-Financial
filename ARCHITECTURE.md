...
`through` is the earlier of the knowledge-horizon end and the Dale-income
authority end. That authority end fails closed at the payroll-modelled
boundary 2026-12-31 while the 2027 Dale pay basis is undecided. The 2026
modelled net is not carried into 2027 on those further rows, and the
Road Ahead 2027 estimated payroll regime is not read. `horizonReason`
states the boundary. When fewer than eight further cycles fit before it,
the reason also states that the owner minimum (the next pay period plus
eight further future periods) is not met until that 2027 basis is decided.
