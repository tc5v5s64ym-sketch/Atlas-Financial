...
5. Today's live plan may overlay current posted balances and pending
   ...
   `ATLAS_LIVE_OVERLAY=fixture|live` enables that clone on local
   `/data.json`. Default production remains the dated opening.
