...
snapshot. The frozen payday opening is a recorded `paydaySnapshot`, payday-morning cash, the non-live dated opening when that opening's as-of is this Forecast start, or `Forecast.establishPaydaySnapshot` from a completeness-proven household-cash walk of that dated opening — never today's live cash, and never a scheduled-only reconstruction that assumes unscheduled gap spending was zero. Payday balance is Dale salary + Amanda salary + recognized Other Income, not that frozen opening plus assigned income and not today's live cash plus remaining paycheques,
