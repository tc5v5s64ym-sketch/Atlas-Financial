...
is the payday operating sheet: live Current Balance is posted household
chequing cash (`paydayAllocation.liveCurrentBalance` from
`Forecast.postedHouseholdChequingCash`: Chequing A / BILLS ACCOUNT plus
Chequing B / WEEKLY SPENDING). Forecast walk and paydayAllocation spendable
