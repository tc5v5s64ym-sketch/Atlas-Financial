...
snapshot. The frozen payday opening is a recorded `paydaySnapshot`, payday-morning cash, the non-live dated opening, or `Forecast.establishPaydaySnapshot` from that dated opening's scheduled joint-cash walk — never today's live cash. Balance after payday is that frozen payday opening plus that
