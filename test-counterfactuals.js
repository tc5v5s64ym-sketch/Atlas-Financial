 ...
 *                        Cover the whole gap and it becomes $1,095/week."
...
}
{
  ...
  ok(cents(c.weekly) === cents(860) && cents(e.weekly) === cents(1095)
    && cents(o.weekly) === cents(1135),
    'and publishes $860 / $1,095 / $1,135 per week by scenario',
 ...
 * the engine would prove only that the engine agrees with itself. */
{
  const cases = [
    ...
    { label: 'buffer $4,000', o: { targetBuffer: 4000 }, cross: null, cap: 1095 },
    { label: 'buffer $5,000', o: { targetBuffer: 5000 }, cross: null, cap: 1095 },
    { label: 'buffer $3,800', o: { targetBuffer: 3800 }, cross: null, cap: 1095 },
  ];
...

{
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      ok(/Cover the whole gap and it becomes \$1,095\/week/.test(t),
