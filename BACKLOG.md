...
- **Bell baseline vs card-paid current bill** — **DONE.** Forward Bell standing is the dated $160.00/month card-paid planning row on the 15th from firstDue 2026-10-15 (`plan.bills` `bell`, Travel Visa reserved gravity). September 2026 is the once row `bell-sep15-2026` $283.94 due 2026-09-15. The June $104.20 + watch $16.80 = $121.00 reconstruction is historical. Q18 stays OPEN for settlement state.
