...
Forecast views (`resolveFundingSources` / `resolveActions`) from current
cash and utilisation. Snapshots remain dated evidence. Do not restore a
second live headroom number on the option row.
