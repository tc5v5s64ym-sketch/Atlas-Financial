...
const suites = [
  ...
  ['standing Fortis / TD / YouTube settlement identities', 'test-bill-settlement-identities.js'],
  ...
  ['Atlas ChatGPT Work REQUIRED review handoff', 'test-atlas-first-review.js'],
  ['Atlas ChatGPT Work wake-up and bridge', 'test-atlas-chatgpt-review.js'],
