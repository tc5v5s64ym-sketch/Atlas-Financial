 ...
 * `node test/test-line-endings.js`
 *
...
ok(Array.isArray(liveIds) && liveIds.length === 9 && liveIds.includes('nearBoundary')
  && liveIds.includes('infeasible'),
  'normalized live forecast.js still yields nine mission ids',
